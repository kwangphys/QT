    ...
    */
    ...
    public class UnitedStates : Calendar
    {
        ...
        public enum Market
        {
            ...
            CME,            //!< Chicago Merchantile exchange calendar
        ...
        private class CME : Calendar.WesternImpl
        {
            public static readonly CME Singleton = new CME();
            private CME() { }

            public override string name() { return "CME"; }
            public override bool isBusinessDay(DateTime date)
            {
                DayOfWeek w = date.DayOfWeek;
                int d = date.Day;
